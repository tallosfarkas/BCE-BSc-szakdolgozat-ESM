...
plt.plot(cumulative_abnormal_returns.index, cumulative_abnormal_returns, label='Kumulatív abnormális hozamok', color='black', linewidth=2)
...
bars[5].set_color(darker_gray)  # Change color of the event date bar
...
plt.xlabel('Napok relatíve az eseményhez képest', fontsize=12)
