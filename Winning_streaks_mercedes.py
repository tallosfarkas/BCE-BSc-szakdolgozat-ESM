...
company_symbols = ['MBGn.DE']
market_index_symbols = [ '.GDAXI']
...
estimation_start_date = '2015-01-01'
estimation_end_date = '2015-12-31'
prediction_start_date = '2016-01-01'
prediction_end_date = '2016-12-31'
...
all_race_dates_and_names = get_all_race_dates_and_names(2016, 2016)
all_race_dates = [date for date, _ in all_race_dates_and_names]
all_race_dates = pd.to_datetime(all_race_dates)

all_race_dates_and_names = all_race_dates_and_names[5:15]
all_race_dates = all_race_dates[5:15]
